...
var SuspensiveProvider_exports = {};
__export(SuspensiveProvider_exports, {
  Suspensive: () => Suspensive,
  SuspensiveProvider: () => SuspensiveProvider
});
module.exports = __toCommonJS(SuspensiveProvider_exports);
...
var SuspenseContext = (0, import_react5.createContext)({ fallback: void 0 });
var useFallbackWithContext = (fallback) => {
  const contextFallback = (0, import_react5.useContext)(SuspenseContext).fallback;
...
var DefaultSuspense = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react5.Suspense, __spreadProps(__spreadValues({}, props), { fallback }));
};
...
var CSROnly = (props) => {
  ...
  const fallback = useFallbackWithContext(props.fallback);
  return isClient ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react5.Suspense, __spreadProps(__spreadValues({}, props), { fallback })) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: fallback });
};
if (process.env.NODE_ENV !== "production") {
...
var Delay = ({ ms, children }) => {
  var _a;
  const delayContextValue = (0, import_react8.useContext)(DelayContext);
  const delayMs = (_a = ms != null ? ms : delayContextValue.ms) != null ? _a : 0;
  const [isDelayed, setIsDelayed] = (0, import_react8.useState)(delayMs === 0);
  useTimeout(() => setIsDelayed(true), delayMs);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: isDelayed ? children : null });
};
if (process.env.NODE_ENV !== "production") {
  Delay.displayName = "Delay";
}
var DelayContext = (0, import_react8.createContext)({ ms: 0 });
...
var SuspensiveProvider = ({ value, children }) => {
  var _a, _b;
  const delayValue = (0, import_react9.useMemo)(() => {
    var _a2;
    return ((_a2 = value.defaultOptions) == null ? void 0 : _a2.delay) || {};
  }, [(_a = value.defaultOptions) == null ? void 0 : _a.delay]);
  const suspenseValue = (0, import_react9.useMemo)(() => {
    var _a2;
    return ((_a2 = value.defaultOptions) == null ? void 0 : _a2.suspense) || {};
  }, [(_b = value.defaultOptions) == null ? void 0 : _b.suspense]);
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(DelayContext.Provider, { value: delayValue, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SuspenseContext.Provider, { value: suspenseValue, children }) });
};
...
//# sourceMappingURL=SuspensiveProvider.cjs.map