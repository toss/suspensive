...
import { createContext as createContext4, useContext as useContext4, useEffect as useEffect4, useMemo as useMemo2, useReducer } from "react";
...
import { Component, createContext as createContext3, forwardRef, useContext as useContext3, useImperativeHandle, useMemo, useRef as useRef3, useState as useState3 } from "react";
...
var ErrorBoundaryGroupContext = createContext4(void 0);
if (process.env.NODE_ENV !== "production") {
...
var ErrorBoundaryGroup = ({ blockOutside = false, children }) => {
  ...
  const parentGroup = useContext4(ErrorBoundaryGroupContext);
...
var useErrorBoundaryGroup = () => {
  const group = useContext4(ErrorBoundaryGroupContext);
