...
var AsyncBoundary_exports = {};
__export(AsyncBoundary_exports, {
  AsyncBoundary: () => AsyncBoundary,
  withAsyncBoundary: () => withAsyncBoundary
});
module.exports = __toCommonJS(AsyncBoundary_exports);
...
var DefaultSuspense = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react6.Suspense, __spreadProps(__spreadValues({}, props), { fallback }));
};
if (process.env.NODE_ENV !== "production") {
...
var CSROnly = (props) => {
  ...
  const fallback = useFallbackWithContext(props.fallback);
  return isClient ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react6.Suspense, __spreadProps(__spreadValues({}, props), { fallback })) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: fallback });
};
if (process.env.NODE_ENV !== "production") {
  ...
  constructor(wrappers) {
    ...
    this.on = (Component2) => {
      const WrappedComponent = (props) => this.wrappers.reduce(
        (acc, [WrapperComponent, wrapperProps]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(WrapperComponent, __spreadProps(__spreadValues({}, wrapperProps), { children: acc })),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Component2, __spreadValues({}, props))
      );
      if (process.env.NODE_ENV !== "production") {
...
var ErrorBoundaryGroupReset = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Trigger, { reset: errorBoundaryGroup.reset });
};
  ...
  render() {
    ...
    if (this.state.isError) {
      if (typeof fallback === "function") {
        ...
        childrenOrFallback = /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(FallbackComponent, { error: this.state.error, reset: this.reset });
      } else {
...
var ErrorBoundary = (0, import_react8.forwardRef)((props, ref) => {
  var _a;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BaseErrorBoundary, __spreadProps(__spreadValues({}, props), { resetKeys, ref: baseErrorBoundaryRef }));
});
if (process.env.NODE_ENV !== "production") {
...
var BaseAsyncBoundary = (0, import_react9.forwardRef)(
  (_a, resetRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ErrorBoundary, __spreadProps(__spreadValues({}, errorBoundaryProps), { ref: resetRef, fallback: rejectedFallback, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Suspense, { fallback: pendingFallback, children }) }));
  }
);
if (process.env.NODE_ENV !== "production") {
  BaseAsyncBoundary.displayName = "AsyncBoundary";
}
var CSROnly2 = (0, import_react9.forwardRef)(
  (_a, resetRef) => {
    var _b = _a, { pendingFallback, rejectedFallback, children } = _b, errorBoundaryProps = __objRest(_b, ["pendingFallback", "rejectedFallback", "children"]);
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ErrorBoundary, __spreadProps(__spreadValues({}, errorBoundaryProps), { ref: resetRef, fallback: rejectedFallback, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Suspense.CSROnly, { fallback: pendingFallback, children }) }));
  }
);
if (process.env.NODE_ENV !== "production") {
...
var withAsyncBoundary = Object.assign(
  (Component2, asyncBoundaryProps) => {
    const Wrapped = (props) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AsyncBoundary, __spreadProps(__spreadValues({}, asyncBoundaryProps), { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Component2, __spreadValues({}, props)) }));
    if (process.env.NODE_ENV !== "production") {
  ...
  },
  {
    ...
    CSROnly: (Component2, asyncBoundaryProps) => {
      const Wrapped = (props) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AsyncBoundary.CSROnly, __spreadProps(__spreadValues({}, asyncBoundaryProps), { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Component2, __spreadValues({}, props)) }));
      if (process.env.NODE_ENV !== "production") {
        const name = Component2.displayName || Component2.name || "Component";
...
//# sourceMappingURL=AsyncBoundary.cjs.map