  ...
  constructor(wrappers) {
    ...
    this.on = (Component2) => {
      const WrappedComponent = (props) => this.wrappers.reduce(
        (acc, [WrapperComponent, wrapperProps]) => /* @__PURE__ */ jsx5(WrapperComponent, __spreadProps(__spreadValues({}, wrapperProps), { children: acc })),
        /* @__PURE__ */ jsx5(Component2, __spreadValues({}, props))
      );
      if (process.env.NODE_ENV !== "production") {
