...
var BaseAsyncBoundary = forwardRef2(
  (_a, resetRef) => {
    ...
    return /* @__PURE__ */ jsx6(ErrorBoundary, __spreadProps(__spreadValues({}, errorBoundaryProps), { ref: resetRef, fallback: rejectedFallback, children: /* @__PURE__ */ jsx6(Suspense, { fallback: pendingFallback, children }) }));
  }
);
if (process.env.NODE_ENV !== "production") {
...
var CSROnly2 = forwardRef2(
  (_a, resetRef) => {
    var _b = _a, { pendingFallback, rejectedFallback, children } = _b, errorBoundaryProps = __objRest(_b, ["pendingFallback", "rejectedFallback", "children"]);
    return /* @__PURE__ */ jsx6(ErrorBoundary, __spreadProps(__spreadValues({}, errorBoundaryProps), { ref: resetRef, fallback: rejectedFallback, children: /* @__PURE__ */ jsx6(Suspense.CSROnly, { fallback: pendingFallback, children }) }));
  }
);
if (process.env.NODE_ENV !== "production") {
...
var withAsyncBoundary = Object.assign(
  (Component2, asyncBoundaryProps) => {
    const Wrapped = (props) => /* @__PURE__ */ jsx6(AsyncBoundary, __spreadProps(__spreadValues({}, asyncBoundaryProps), { children: /* @__PURE__ */ jsx6(Component2, __spreadValues({}, props)) }));
    if (process.env.NODE_ENV !== "production") {
  ...
  },
  {
    ...
    CSROnly: (Component2, asyncBoundaryProps) => {
      const Wrapped = (props) => /* @__PURE__ */ jsx6(AsyncBoundary.CSROnly, __spreadProps(__spreadValues({}, asyncBoundaryProps), { children: /* @__PURE__ */ jsx6(Component2, __spreadValues({}, props)) }));
      if (process.env.NODE_ENV !== "production") {
        const name = Component2.displayName || Component2.name || "Component";
