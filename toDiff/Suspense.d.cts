 ...
 */
declare const withSuspense: (<TProps extends {} = Record<string, never>>(component: ComponentType<TProps>, suspenseProps?: PropsWithoutChildren<SuspenseProps>) => {
     ...
     */
    CSROnly: <TProps_1 extends {} = Record<string, never>>(component: ComponentType<TProps_1>, suspenseProps?: PropsWithoutChildren<SuspenseProps>) => {
