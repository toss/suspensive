...
var ErrorBoundaryGroup = ({ blockOutside = false, children }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ErrorBoundaryGroupContext.Provider, { value, children });
};
if (process.env.NODE_ENV !== "production") {
...
var ErrorBoundaryGroupReset = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Trigger, { reset: errorBoundaryGroup.reset });
};
  ...
  render() {
    ...
    if (this.state.isError) {
      if (typeof fallback === "function") {
        ...
        childrenOrFallback = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FallbackComponent, { error: this.state.error, reset: this.reset });
      } else {
        childrenOrFallback = fallback;
      }
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ErrorBoundaryContext.Provider, { value: __spreadProps(__spreadValues({}, this.state), { reset: this.reset }), children: childrenOrFallback });
  }
};
var ErrorBoundary = (0, import_react8.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BaseErrorBoundary, __spreadProps(__spreadValues({}, props), { resetKeys, ref: baseErrorBoundaryRef }));
});
if (process.env.NODE_ENV !== "production") {
  ...
  constructor(wrappers) {
    ...
    this.on = (Component2) => {
      const WrappedComponent = (props) => this.wrappers.reduce(
        (acc, [WrapperComponent, wrapperProps]) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(WrapperComponent, __spreadProps(__spreadValues({}, wrapperProps), { children: acc })),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Component2, __spreadValues({}, props))
      );
      if (process.env.NODE_ENV !== "production") {
