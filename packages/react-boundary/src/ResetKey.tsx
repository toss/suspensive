import { ComponentProps, ComponentType, ReactNode, createContext, useContext } from 'react'
...
const withResetKeyProviderConsumer =
  <P extends Record<string, unknown> = Record<string, never>>(
    Component: ComponentType<P & Parameters<ComponentProps<typeof ResetKeyConsumer>['children']>[0]>
  ) =>
  (props: P) =>
    (
      <ResetKeyProvider>
