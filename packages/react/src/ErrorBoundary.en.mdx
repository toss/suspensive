...
Any rendering errors in children of this component can be handled.

### props.fallback

If there is any thrown error in children of `<ErrorBoundary/>`, Error will be catched and then fallback will be rendered.
...
Details are introduced in [`<ErrorBoundaryGroup/>` page](./ErrorBoundaryGroup.i18n).
