 ...
 *
 * @description
 * HydrateQueries is designed for React Server Components (RSC).
 ...
 * import { HydrateQueries } from '@suspensive/react-query'
 ...
 *         <HydrateQueries queries={[userQueryOptions(userId)]}>
 *           <UserProfile />
 *         </HydrateQueries>
 *       </Suspense>
 *
 *       <Suspense fallback={<div>Loading posts...</div>}>
 *         <HydrateQueries queries={[postsQueryOptions()]}>
 *           <PostsList />
 *         </HydrateQueries>
 *       </Suspense>
 *     </>
 ...
 * ```
 *
 * @see {@link https://suspensive.org/docs/react-query/HydrateQueries Documentation}
 */
export async function HydrateQueries({
  ...
  const timeoutController =
    timeout != null && timeout >= 0
      ? createTimeoutController(timeout, `HydrateQueries: timeout after ${timeout} ms)`)
      : undefined
  try {
