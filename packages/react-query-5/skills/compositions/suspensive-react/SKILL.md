...
description: >-
  Composition seam between @suspensive/react-query-5 and @suspensive/react:
...
Wrong:
```tsx
import { QueryErrorBoundary } from '@suspensive/react-query-5'
...
See also: ../../react-query/declarative-queries/SKILL.md for SuspenseQuery itself, @suspensive/react skills/react/error-handling for shouldCatch/resetKeys/ErrorBoundaryGroup, @suspensive/react skills/react/loading-ux for Delay and isDelayed fades.
