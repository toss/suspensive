...
// https://github.com/TanStack/query/blob/main/packages/react-query-next-experimental/src/HydrationStreamProvider.tsx
...
export function createHydrationStreamProvider<TShape>() {
  ...
  function UseClientHydrationStreamProvider(props: {
    ...
    return <context.Provider value={{ stream, id }}>{props.children}</context.Provider>
  }
