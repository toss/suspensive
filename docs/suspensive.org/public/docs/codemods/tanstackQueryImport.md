---
url: /docs/codemods/tanstackQueryImport
---

# Migrate TanStack Query imports

> **Info:** - We recommend upgrading to `@tanstack/react-query@5` when using `@suspensive/react-query` with `@tanstack/react-query@4`.
