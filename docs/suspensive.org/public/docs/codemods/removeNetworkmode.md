---
url: /docs/codemods/removeNetworkmode
---

# Remove `networkMode`

> **Info:** We recommend running this when upgrading from `@suspensive/react-query` v2 & `@tanstack/react-query@4` to `@suspensive/react-query` v3.
