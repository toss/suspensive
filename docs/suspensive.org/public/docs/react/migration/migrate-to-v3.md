---
url: /docs/react/migration/migrate-to-v3
---
...
> **Note:** Errors thrown from the fallback of AS-IS v2 ErrorBoundary cannot be handled by the parent ErrorBoundary, so they are caught by themselves and fallbacks are exposed recursively.
> 
