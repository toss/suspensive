---
url: /docs/react/migration/migrate-to-v2
---
...
### New [`wrap`](https://v2.suspensive.org/docs/react/wrap) builder [#270](https://github.com/toss/suspensive/pull/270)
...
These all HOCs can be replaced beautifully by new HOC builder [`wrap`](https://v2.suspensive.org/docs/react/wrap) in v2.
