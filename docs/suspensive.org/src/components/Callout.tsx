...
type CalloutProps = Omit<ComponentPropsWithoutRef<typeof NextraCallout>, 'type'> & {
  type: 'deprecated' | 'experimental' | ComponentPropsWithoutRef<typeof NextraCallout>['type']
}
