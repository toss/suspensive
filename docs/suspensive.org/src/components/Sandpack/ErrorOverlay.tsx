import { ErrorOverlay as SandpackErrorOverlay, useErrorMessage } from '@codesandbox/sandpack-react'
...
export const ErrorOverlay = () => {
  ...
  const privateDependencyError = errorMessage?.includes('NPM_REGISTRY_UNAUTHENTICATED_REQUEST')
