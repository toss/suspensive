...
## `@suspensive/react-query` v4의 Network Mode

Suspensive v3부터 `@suspensive/react-query` v4의 `networkMode`의 기본값이 `'always'`로 변경되었습니다.  
자세한 내용은 [v3로 마이그레이션하기 문서](./migrate-to-v3.mdx)를 참고하세요.
