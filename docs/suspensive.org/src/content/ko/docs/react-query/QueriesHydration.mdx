---
description: 'QueriesHydration으로 프리페치된 여러 쿼리를 한번에 하이드레이션. Next.js App Router 데이터 페칭 간소화.'
---
...
`<QueriesHydration/>`는 deprecated되었습니다. [`<HydrationBoundary/>`](/docs/react-query/HydrationBoundary) (`@tanstack/react-query` v5) 또는 [`<Hydrate/>`](/docs/react-query/Hydrate) (`@tanstack/react-query` v4)를 대신 사용해주세요.
...
| Version   | Changes                                                                                                               |
| --------- | --------------------------------------------------------------------------------------------------------------------- |
| `v3.21.0` | `<QueriesHydration/>`가 deprecated되었습니다. `<HydrationBoundary/>` (v5) 또는 `<Hydrate/>` (v4)를 대신 사용해주세요. |
