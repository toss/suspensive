...
<Cards num={2}>
  <Cards.Card title="@suspensive/react v2 보기" href="/docs/react/migration/migrate-to-v2" />
  <Cards.Card title="@suspensive/react-query v2 보기" href="/docs/react-query/migration/migrate-to-v2" />
</Cards>
