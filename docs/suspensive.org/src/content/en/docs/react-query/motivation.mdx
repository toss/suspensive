...
From version 2.2.0 onwards, @suspensive/react-query supports both TanStack Query v4 and v5. To support older browsers, pair it with v4.

</Callout>

TanStack Query v5 requires Safari >= 15 due to ES private fields, but many teams still need to support Safari 12–14. With Suspensive's [v4 & v5 support](/docs/react-query/tanstack-query-compatibility), you get the v5 interface while keeping older browser compatibility.
