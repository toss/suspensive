...
**Deprecated in TanStack Query v4.41.0+**

This interface is now officially supported in TanStack Query v4.41.0+. Please migrate to the official TanStack Query interface:
