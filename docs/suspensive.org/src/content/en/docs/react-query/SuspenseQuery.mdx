...
| Version  | Changes                                                                                                                                                                           |
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v3.0.0` | The default value of `networkMode` in `@suspensive/react-query` has been fixed to `'always'`. For more details, please refer to the [Migration to v3 guide](./migrate-to-v3.mdx). |
