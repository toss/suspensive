---
description: 'Hydrate multiple prefetched queries at once with QueriesHydration. Simplifies Next.js App Router data fetching.'
---
...
`<QueriesHydration/>` is deprecated. Use [`<HydrationBoundary/>`](/docs/react-query/HydrationBoundary) (for `@tanstack/react-query` v5) or [`<Hydrate/>`](/docs/react-query/Hydrate) (for `@tanstack/react-query` v4) instead.
...
| Version  | Changes                                                                                                                   |
| -------- | ------------------------------------------------------------------------------------------------------------------------- |
| `v3.21.0` | `<QueriesHydration/>` has been deprecated. Use `<HydrationBoundary/>` (v5) or `<Hydrate/>` (v4) instead. |
