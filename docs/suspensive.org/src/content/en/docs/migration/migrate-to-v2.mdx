...
<Cards num={2}>
  <Cards.Card title="See @suspensive/react v2" href="/docs/react/migration/migrate-to-v2" />
  <Cards.Card title="See @suspensive/react-query v2" href="/docs/react-query/migration/migrate-to-v2" />
</Cards>
