...
<Cards num={2}>
  <Cards.Card title="See @suspensive/react v3" href="/docs/react/migration/migrate-to-v3" />
  <Cards.Card title="See @suspensive/react-query v3" href="/docs/react-query/migration/migrate-to-v3" />
</Cards>
