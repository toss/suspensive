---
description: 'Hook to detect client-side environment. Returns true only on the client, false during SSR. Used internally by ClientOnly and Suspense clientOnly.'
---
