---
description: 'Manage and reset multiple ErrorBoundary components at once with ErrorBoundaryGroup. No prop drilling needed — reset nested error boundaries from anywhere.'
---
