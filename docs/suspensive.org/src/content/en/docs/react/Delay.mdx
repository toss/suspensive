---
description: 'Delay component to prevent flash-of-loading-state. Delay children rendering by milliseconds or use render props for timed visibility control.'
---
