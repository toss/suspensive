...
**Note:** The default `lazy` export is equivalent to `createLazy({})` - a lazy function with no default options.

```tsx
// These are equivalent:
import { lazy, createLazy } from '@suspensive/react'
const Component1 = lazy(() => import('./Component'))

const Component2 = createLazy({})(() => import('./Component'))
```
