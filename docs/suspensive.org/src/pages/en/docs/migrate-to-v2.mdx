...
<Cards num={2}>
  <Cards.Card title="See @suspensive/react v2" href="/docs/react/migrate-to-v2" />
  <Cards.Card title="See @suspensive/react-query v2" href="/docs/react-query/migrate-to-v2" />
</Cards>
