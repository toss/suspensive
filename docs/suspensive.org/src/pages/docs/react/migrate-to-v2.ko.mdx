...
### 새로운 [`<DevMode/>`](/docs/react/DevMode) [#470](https://github.com/toss/suspensive/pull/470)
...
### 새로운 [`wrap`](/docs/react/wrap) 빌더 [#270](https://toss/suspensive/pull/270)
...
### 새로운 `<ErrorBoundary/>`의 `shouldCatch` prop [#569](https://toss/suspensive/pull/569)
...
### 새로운 [`<ErrorBoundary.Consumer/>`](/docs/react/ErrorBoundary), [`<ErrorBoundaryGroup.Consumer/>`](/docs/react/ErrorBoundaryGroup) 컴포넌트 [#610](https://toss/suspensive/pull/610)
...
v2에서는 `<AsyncBoundary/>`를 제거했습니다[#295](https://toss/suspensive/issues/295).
