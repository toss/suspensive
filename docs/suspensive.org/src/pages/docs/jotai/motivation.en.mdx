...
By using it together with [@suspensive/react](https://suspensive.org/ko/docs/react/motivation), you can use Suspense more powerfully and conveniently.

### Use Async Atoms Declaratively

The provided components have the same interface props as Jotai and can be used declaratively. This allows you to clearly express what triggers Suspense at the same depth, similar to [SuspenseQuery in @suspensive/react-query](https://suspensive.org/ko/docs/react-query/SuspenseQuery).
