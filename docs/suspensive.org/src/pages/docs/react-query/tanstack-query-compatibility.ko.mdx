...
현재 사용자 환경에 설치된 @tanstack/react-query의 버전과 호환되는 @suspensive/react-query의 인터페이스를 확인하고, 호환 상태를 확인할 수 있습니다.
...
status로 호환 상태를 확인할 수 있으며, available interfaces 항목에서 현재 사용자 환경에서 사용할 수 있는 인터페이스를 확인할 수 있습니다.
