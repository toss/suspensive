...
### 새로운 [`<DevMode/>`](./react/DevMode) 컴포넌트 [#470](https://github.com/suspensive/react/pull/470)
...
### 새로운 `<ErrorBoundary/>`의 `shouldCatch` prop [#569](https://github.com/suspensive/react/pull/569)
...
queryKey, queryFn을 더 이상 분리해 받지 않습니다. 이는 많은 함수 오버라이딩을 만들 뿐 아니라 react-query v5로 마이그레이션 해야하는 유저에게는 필수적인 변경입니다.
